...
The first block((("blockchain", "genesis block", id="blockchain-genesis")))((("genesis block", id="genesis-block"))) in the blockchain is called the _genesis block_
...
first block by Satoshi Nakamoto, Bitcoin's ((("blockchain", "genesis block", startref="blockchain-genesis")))((("genesis block", startref="genesis-block")))creator.
