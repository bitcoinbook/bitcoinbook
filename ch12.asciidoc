...
For example, if commitment transaction 1 is timelocked to 3600 blocks, commitment transaction 2 is timelocked to 3599 blocks, and so on, then commitment transaction 600 can be spent 600 blocks earlier than commitment transaction 1.
