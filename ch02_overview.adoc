...
Alice's ((("transaction chains", id="transaction-chain-example")))payment to Bob's Store uses a
...
that's what the protocol itself ((("satoshis")))((("transaction chains", id="transaction-chain-example")))uses.
====
