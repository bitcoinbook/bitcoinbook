...
Peers in ((("Bitcoin", "as peer-to-peer network")))((("peer-to-peer networks", "Bitcoin as")))the Bitcoin peer-to-peer network are programs that have both
...
Transactions are bundled((("transactions", "blocks")))((("blocks"))) into _blocks_.  Blocks have a very small header
...
blockchain. The block containing Alice's transaction is counted as ((("confirmations")))one
