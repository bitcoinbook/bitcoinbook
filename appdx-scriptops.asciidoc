...
<<tx_script_ops_table_pushdata>> shows operators for pushing values onto the stack.((("bitcoin", "Script languge operators, constants, and symbols", id="BCscript14")))((("transactions", "scripts and Script language", "operators, constants, and symbols", id="TRlang14")))
...
<<tx_script_ops_table_internal>> shows operator codes reserved for use by the internal script parser.((("", startref="BCscript14")))((("", startref="TRlang14")))
