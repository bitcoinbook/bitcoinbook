...
[TIP]
====
The price of bitcoin has changed a lot over time. As of March 2021, a person would need approximately $54,000 USD to purchase one whole bitcoin. Some examples in this book reference real-life _past_ transactions that have taken place, which allow readers (or anyone!) to search for them on the blockchain using online tools. In later chapters, interacting with this data can deepen your understanding of how Bitcoin operates. Having said this, today's exchange rate might suggest that the characters in these stories have highly irregular motivations. At the end of this chapter, as a fun thought experiment, think about how generous of a friend Joe (one of Alice's friends, whom you will soon meet) would have to be if he had made the same agreement with Alice today. In the next chapter, you might also notice that Alice _really_ loves coffee!
====
