...
*NB:* As of June 2014, the latest released version of _pycoin_ is 0.42, and *all examples here are based on _pycoin_ version 0.42*; be warned that it is still under active development, so later versions may have changed the API or behavior of command-line tools.
