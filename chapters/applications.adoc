...
https://bit.ly/2rBHeoL[_Basics of Lightning Technology (BOLT)_ repository].
...
long-term public key that they https://bit.ly/2r5TACm[use as an
...
scheme called https://bit.ly/2q6ZDrP[Sphinx]. This routing protocol
