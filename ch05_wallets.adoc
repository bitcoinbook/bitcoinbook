...
The index number ((("index numbers", "for hardened derivation", secondary-sortas="hardened derivation")))used in the derivation function is a 32-bit integer. To
...
Keys in ((("path references", "in HD wallets", secondary-sortas="HD wallets")))((("key generation", "HD (hierarchical deterministic)", "path references")))((("HD (hierarchical deterministic) key generation", "path references")))an HD wallet are
