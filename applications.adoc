...
When operating correctly and over the
...
_Payment channels_ ((("payment (state) channels","defined")))are a trustless mechanism for exchanging Bitcoin
...
((("routed paymentchannels", see="Lightning Network")))((("Lightning Network",
